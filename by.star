...
local PlayerESP = {enabled = false, playerData = {}, conns = {}, discordText = "discord.gg/Ch5ZmEKmn"}
...
local function setupSpeedIndicator(char)
	...
	discordLbl.Text="discord.gg/Ch5ZmEKmn"
...
local function buildGui()
	...
	miniBtn.Text="STAR";miniBtn.TextColor3=THEME_ACCENT;miniBtn.Font=Enum.Font.GothamBold;miniBtn.TextSize=12
	...
	-- FPS آ· PING info on the right (now occupies the full right area)
	...
	progressRadLbl.BackgroundTransparency=1;progressRadLbl.Text="-- آ· --"
	...
	-- live FPS آ· PING update â€” reuses the stats loop pattern from the main header
	task.spawn(function()
		local lastFrame = tick()
		local fpsSamples = {}; local fpsAvg = 60
		RunService.RenderStepped:Connect(function()
